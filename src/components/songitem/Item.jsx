...
const Item = () => {
  ...
  return (
    ...
    <div className={styles.songItem}>
      ...
      <img
        src={songArray[0].album.cover_small}
        alt={songArray[0].album.title_short}
      />
      <h3>{songArray[0].title_short}</h3>
      <p>{songArray[0].artist.name}</p>
      <div className={styles.info}>
        <p>{songArray[0].duration} seconds</p>
        <p>{songArray[0].rank} streams</p>
