...
;
    ...
    useEffect(() => {
      try {
        const storedFavoriteAlbums = JSON.parse(localStorage.getItem("favoriteAlbums")) || [];
    ...
    useEffect(() => {
      const storedFavorites = JSON.parse(localStorage.getItem("favoriteAlbums")) || [];
    ...
    <div className={styles.FavoriteAlbumPage}>
      ...
      <div className={styles.albums}>
        {favoriteAlbums.map((favAlbum) => (
            <Home_Page_AlbumItem key={favAlbum.id} 
            data={favAlbum} 
