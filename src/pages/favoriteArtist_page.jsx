...
;
    ...
    useEffect(() => {
      try {
        const storedFavoriteArtists = JSON.parse(localStorage.getItem("favoriteArtists")) || [];
    ...
    useEffect(() => {
      const storedFavoriteArtists = JSON.parse(localStorage.getItem("favoriteArtists")) || [];
      if (JSON.stringify(favoriteArtists) !== JSON.stringify(storedFavoriteArtists)) {
        setFavoriteArtists(storedFavoriteArtists);
      }
    }, [favoriteArtists]);
    ...
    <div className={styles.FavoriteArtistPage}>
      ...
      <div className={styles.Artists}>
        {favoriteArtists.map((favArtist) => (
            <Home_Page_ArtistItem key={favArtist.id} 
            data={favArtist} 
